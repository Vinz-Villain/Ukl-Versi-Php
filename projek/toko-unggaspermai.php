    ...
    <main>
        ...
        <section class="products">
            ...
            <div class="product">
                ...
                <p>Harga: Rp 8.750</p>
                <button onclick="addToCart('Paha Ayam 250 gr', 8750)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3>Paha Ayam 500 gr</h3>
                <p>Harga: Rp 17.500</p>
                <button onclick="addToCart('Paha Ayam 500 gr', 17500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3> Paha Ayam 1kg </h3>
                <p>Harga: Rp 35.000</p>
                <button onclick="addToCart('Paha Ayam 1kg', 35000)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 250 gr</h3>
                <p>Harga: Rp 8.750</p>
                <button onclick="addToCart('Dada Ayam 250 gr', 8750)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 500 gr</h3>
                <p>Harga: Rp 17.500</p>
                <button onclick="addToCart('Dada Ayam 500 gr', 17500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 1 kg</h3>
                <p>Harga: Rp 35.000</p>
                <button onclick="addToCart('Dada Ayam 1 kg', 35000)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 100 gr<h3>
                <p>Harga: Rp 3.900</p>
                <button onclick="addToCart('Sayap Ayam 100 gr', 3900)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 200 gr<h3>
                <p>Harga: Rp 7.800</p>
                <button onclick="addToCart('Sayap Ayam 200 gr', 7800)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 100 gr<h3>
                <p>Harga: Rp 1.400</p>
                <button onclick="addToCart('Kepala Ayam 100 gr', 1400)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 200 gr<h3>
                <p>Harga: Rp 2.800</p>
                <button onclick="addToCart('Kepala Ayam 200 gr', 2800)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 100 gr<h3>
                <p>Harga: Rp 1.400</p>
                <button onclick="addToCart('Rempela&Ati 100 gr', 1400)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 200 gr <h3>
                <p>Harga: Rp 2.800</p>
                <button onclick="addToCart('Rempela&Ati 200 gr', 2800)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 100 gr<h3>
                <p>Harga: Rp 1.700</p>
                <button onclick="addToCart('Ceker Ayam 100 gr', 1700)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 200 gr<h3>
                <p>Harga: Rp 3.400</p>
                <button onclick="addToCart('Ceker Ayam 200 gr', 3400)">Beli Sekarang</button>
            </div>
