    ...
    <main>
        ...
        <section class="products">
            ...
            <div class="product">
                ...
                <p>Harga: Rp 9.375</p>
                <button onclick="addToCart('Paha Ayam 250 gr', 9375)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3>Paha Ayam 500 gr</h3>
                <p>Harga: Rp 18.750</p>
                <button onclick="addToCart('Paha Ayam 500 gr', 18750)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3> Paha Ayam 1kg </h3>
                <p>Harga: Rp 37.500</p>
                <button onclick="addToCart('Paha Ayam 1kg', 37500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 250 gr</h3>
                <p>Harga: Rp 9.375</p>
                <button onclick="addToCart('Dada Ayam 250 gr', 9375)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 500 gr</h3>
                <p>Harga: Rp 18.750</p>
                <button onclick="addToCart('Dada Ayam 500 gr', 18750)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 1 kg</h3>
                <p>Harga: Rp 37.500</p>
                <button onclick="addToCart('Dada Ayam 1 kg', 37500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 100 gr<h3>
                <p>Harga: Rp 4.150</p>
                <button onclick="addToCart('Sayap Ayam 100 gr', 4150)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 200 gr<h3>
                <p>Harga: Rp 8.300</p>
                <button onclick="addToCart('Sayap Ayam 200 gr', 8300)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 100 gr<h3>
                <p>Harga: Rp 1.650</p>
                <button onclick="addToCart('Kepala Ayam 100 gr', 1650)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 200 gr<h3>
                <p>Harga: Rp 3.300</p>
                <button onclick="addToCart('Kepala Ayam 200 gr', 3300)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 100 gr<h3>
                <p>Harga: Rp 1.650</p>
                <button onclick="addToCart('Rempela&Ati 100 gr', 1650)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 200 gr <h3>
                <p>Harga: Rp 3.300</p>
                <button onclick="addToCart('Rempela&Ati 200 gr', 3300)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 100 gr<h3>
                <p>Harga: Rp 1.950</p>
                <button onclick="addToCart('Ceker Ayam 100 gr', 1950)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 200 gr<h3>
                <p>Harga: Rp 3.900</p>
                <button onclick="addToCart('Ceker Ayam 200 gr', 3900)">Beli Sekarang</button>
            </div>
