    ...
    <main>
        ...
        <section class="products">
            ...
            <div class="product">
                ...
                <p>Harga: Rp 9.125</p>
                <button onclick="addToCart('Paha Ayam 250 gr', 9125)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3>Paha Ayam 500 gr</h3>
                <p>Harga: Rp 18.250</p>
                <button onclick="addToCart('Paha Ayam 500 gr', 18250)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="paha-ayam.jpg" alt="Dada Ayam" max width="100">
                <h3> Paha Ayam 1kg </h3>
                <p>Harga: Rp 36.500</p>
                <button onclick="addToCart('Paha Ayam 1kg', 36500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 250 gr</h3>
                <p>Harga: Rp 9.125</p>
                <button onclick="addToCart('Dada Ayam 250 gr', 9125)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 500 gr</h3>
                <p>Harga: Rp 18.250</p>
                <button onclick="addToCart('Dada Ayam 500 gr', 18250)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="dada-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Dada Ayam 1 kg</h3>
                <p>Harga: Rp 36.500</p>
                <button onclick="addToCart('Dada Ayam 1 kg', 36500)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 100 gr<h3>
                <p>Harga: Rp 4.050</p>
                <button onclick="addToCart('Sayap Ayam 100 gr', 4050)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="sayap-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Sayap Ayam 200 gr<h3>
                <p>Harga: Rp 8.100</p>
                <button onclick="addToCart('Sayap Ayam 200 gr', 8100)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 100 gr<h3>
                <p>Harga: Rp 1.550</p>
                <button onclick="addToCart('Kepala Ayam 100 gr', 1550)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="kepala-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Kepala Ayam 200 gr<h3>
                <p>Harga: Rp 3.100</p>
                <button onclick="addToCart('Kepala Ayam 200 gr', 3100)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 100 gr<h3>
                <p>Harga: Rp 1.550</p>
                <button onclick="addToCart('Rempela&Ati 100 gr', 1550)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="rempela&ati-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Rempela&Ati 200 gr <h3>
                <p>Harga: Rp 3.100</p>
                <button onclick="addToCart('Rempela&Ati 200 gr', 3100)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 100 gr<h3>
                <p>Harga: Rp 1.850</p>
                <button onclick="addToCart('Ceker Ayam 100 gr', 1850)">Beli Sekarang</button>
            </div>
            <div class="product">
                <img src="ceker-ayam.jpg" alt="Dada Ayam" max width="110">
                <h3>Ceker Ayam 200 gr<h3>
                <p>Harga: Rp 3.700</p>
                <button onclick="addToCart('Ceker Ayam 200 gr', 3700)">Beli Sekarang</button>
            </div>
